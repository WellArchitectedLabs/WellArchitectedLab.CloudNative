export default function ForecastCard({ forecast }) {
  const { date, temperatureC, temperatureF, summary } = forecast;
  ...
  return (
    <div className="bg-white/20 backdrop-blur-lg p-6 rounded-2xl shadow-lg transform transition hover:-translate-y-1 hover:shadow-2xl">
      ...
      <p className="text-6xl font-bold mb-2">{temperatureC}°C</p>
      <p className="text-sm text-gray-200">({temperatureF}°F)</p>
